...
#ifndef THINKS_PNM_IO_TEST_UTILS_CATCH_UTILS_H_INCLUDED
#define THINKS_PNM_IO_TEST_UTILS_CATCH_UTILS_H_INCLUDED
...
#endif  // THINKS_PNM_IO_TEST_UTILS_CATCH_UTILS_H_INCLUDED
